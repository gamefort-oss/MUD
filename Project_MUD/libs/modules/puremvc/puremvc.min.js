...
};e.prototype.compareNotifyContext=function(f){return f===this.context};return e})();d.Observer=c})(puremvc||(puremvc={}));var b;(function(c){var d=(function(){function e(f){this.mediatorMap=null;this.observerMap=null;this.multitonKey=null;if(e.instanceMap[f]){throw Error(e.MULTITON_MSG)}e.instanceMap[f]=this;this.multitonKey=f;this.mediatorMap={};this.observerMap={};this.initializeView()}e.prototype.initializeView=function(){};e.prototype.registerObserver=function(g,f){var h=this.observerMap[g];if(h){h.push(f)
...
h.onRemove();return h};e.prototype.hasMediator=function(f){return this.mediatorMap[f]!=null};e.getInstance=function(f){if(!e.instanceMap[f]){e.instanceMap[f]=new e(f)}return e.instanceMap[f]};e.removeView=function(f){delete e.instanceMap[f]};e.MULTITON_MSG="View instance for this multiton key already constructed!";e.instanceMap={};return e})();c.View=d})(puremvc||(puremvc={}));var b;(function(c){var d=(function(){function e(f){this.view=null;this.commandMap=null;this.multitonKey=null;if(e.instanceMap[f]){throw Error(e.MULTITON_MSG)
...
};e.getInstance=function(f){if(!e.instanceMap[f]){e.instanceMap[f]=new e(f)}return e.instanceMap[f]};e.removeModel=function(f){delete e.instanceMap[f]};e.MULTITON_MSG="Model instance for this multiton key already constructed!";e.instanceMap={};return e})();c.Model=d})(puremvc||(puremvc={}));var b;(function(c){var d=(function(){function e(g,f,h){if(typeof f==="undefined"){f=null}if(typeof h==="undefined"){h=null}this.name=null;this.body=null;this.type=null;this.name=g;this.body=f;this.type=h}e.prototype.getName=function(){return this.name
};e.prototype.setBody=function(f){this.body=f};e.prototype.getBody=function(){return this.body};e.prototype.setType=function(f){this.type=f};e.prototype.getType=function(){return this.type};e.prototype.toString=function(){var f="Notification Name: "+this.getName();f+="\nBody:"+((this.getBody()==null)?"null":this.getBody().toString());f+="\nType:"+((this.getType()==null)?"null":this.getType());return f};return e})();c.Notification=d})(puremvc||(puremvc={}));var b;(function(d){var c=(function(){function e(f){this.model=null;
...
delete e.instanceMap[f]};e.MULTITON_MSG="Facade instance for this multiton key already constructed!";e.instanceMap={};return e})();d.Facade=c})(puremvc||(puremvc={}));var b;(function(d){var c=(function(){function e(){this.multitonKey=null}e.prototype.initializeNotifier=function(f){this.multitonKey=f};e.prototype.sendNotification=function(g,f,h){if(typeof f==="undefined"){f=null}if(typeof h==="undefined"){h=null}if(this.facade()){this.facade().sendNotification(g,f,h)}};e.prototype.facade=function(){if(this.multitonKey===null){throw Error(e.MULTITON_MSG)
}return d.Facade.getInstance(this.multitonKey)};e.MULTITON_MSG="multitonKey for this Notifier not yet initialized!";return e})();d.Notifier=c})(puremvc||(puremvc={}));var a=this.__extends||function(g,c){for(var f in c){if(c.hasOwnProperty(f)){g[f]=c[f]}}function e(){this.constructor=g}e.prototype=c.prototype;g.prototype=new e()};var b;(function(d){var c=(function(f){a(e,f);function e(){f.call(this);this.subCommands=null;this.subCommands=new Array();this.initializeMacroCommand()}e.prototype.initializeMacroCommand=function(){};
e.prototype.addSubCommand=function(g){this.subCommands.push(g)};e.prototype.execute=function(l){var j=this.subCommands.slice(0);var g=this.subCommands.length;for(var h=0;h<g;h++){var m=j[h];var k=new m();k.initializeNotifier(this.multitonKey);k.execute(l)}this.subCommands.splice(0)};return e})(d.Notifier);d.MacroCommand=c})(puremvc||(puremvc={}));var b;(function(c){var d=(function(e){a(f,e);function f(){e.apply(this,arguments)}f.prototype.execute=function(g){};return f})(c.Notifier);c.SimpleCommand=d})(puremvc||(puremvc={}));
